...
def get_dataset(mode='sweep', shapenet_subset = "airplanes"):
    ...
    if mode == 'meshproportional':
        return MeshProportionalData
...
class Random(Dataset):
    ...
    def __getitem__(self, item):
        ...
        #return self.single(self.args.D2).to(self.device)
...
class MeshProportionalData(SubsetData):
    def __init__(self, pc, real_device, args):
